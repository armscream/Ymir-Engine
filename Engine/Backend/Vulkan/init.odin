...
vulkan_debug_callback :: proc "system" (
	...
	if p_callback_data == nil || p_callback_data.pMessage == nil {
		fmt.println("[VK DEBUG] Callback data is null")
		return false
	}
...
engine_init :: proc(self: ^Engine) -> (ok: bool) {
	...
	self.name_for_node = make(map[string]u32)

	glfw.SetFramebufferSizeCallback(self.window, callback_framebuffer_size) // Set window callbacks
...
engine_init_vulkan :: proc(self: ^Engine) -> (ok: bool) {
	...
	when ODIN_DEBUG {
		...
		vkb.instance_set_debug_callback(&instance_builder, vulkan_debug_callback)
		...
		// Keep monitor layer disabled while stabilizing startup. It is optional.
	}
	...
	vk.load_proc_addresses_device(self.vk_device)

	// On Vulkan 1.1+/1.3 drivers, some KHR aliases are not exported.
	// Map them to their promoted core entry points.
	if vk.GetPhysicalDeviceMemoryProperties2KHR == nil {
		vk.GetPhysicalDeviceMemoryProperties2KHR = auto_cast vk.GetPhysicalDeviceMemoryProperties2
	}
	if vk.GetBufferMemoryRequirements2KHR == nil {
		vk.GetBufferMemoryRequirements2KHR = auto_cast vk.GetBufferMemoryRequirements2
	}
	if vk.GetImageMemoryRequirements2KHR == nil {
		vk.GetImageMemoryRequirements2KHR = auto_cast vk.GetImageMemoryRequirements2
	}
	if vk.BindBufferMemory2KHR == nil {
		vk.BindBufferMemory2KHR = auto_cast vk.BindBufferMemory2
	}
	if vk.BindImageMemory2KHR == nil {
		vk.BindImageMemory2KHR = auto_cast vk.BindImageMemory2
	}
	if vk.GetDeviceBufferMemoryRequirementsKHR == nil {
		vk.GetDeviceBufferMemoryRequirementsKHR = auto_cast vk.GetDeviceBufferMemoryRequirements
	}
	if vk.GetDeviceImageMemoryRequirementsKHR == nil {
		vk.GetDeviceImageMemoryRequirementsKHR = auto_cast vk.GetDeviceImageMemoryRequirements
	}
	defer if !ok {
		vkb.destroy_device(self.vkb.device)
	}
	...
	if vma_vulkan_functions.get_physical_device_properties == nil {
		vma_vulkan_functions.get_physical_device_properties = auto_cast vk.GetInstanceProcAddr(self.vk_instance, "vkGetPhysicalDeviceProperties")
	}
	if vma_vulkan_functions.get_physical_device_memory_properties == nil {
		vma_vulkan_functions.get_physical_device_memory_properties = auto_cast vk.GetInstanceProcAddr(self.vk_instance, "vkGetPhysicalDeviceMemoryProperties")
	}
	if vma_vulkan_functions.get_physical_device_memory_properties2_khr == nil {
		vma_vulkan_functions.get_physical_device_memory_properties2_khr = auto_cast vk.GetInstanceProcAddr(self.vk_instance, "vkGetPhysicalDeviceMemoryProperties2")
	}
	if vma_vulkan_functions.create_image == nil {
		vma_vulkan_functions.create_image = auto_cast vk.GetDeviceProcAddr(self.vk_device, "vkCreateImage")
	}
	if vma_vulkan_functions.get_image_memory_requirements == nil {
		vma_vulkan_functions.get_image_memory_requirements = auto_cast vk.GetDeviceProcAddr(self.vk_device, "vkGetImageMemoryRequirements")
	}
	if vma_vulkan_functions.bind_image_memory == nil {
		vma_vulkan_functions.bind_image_memory = auto_cast vk.GetDeviceProcAddr(self.vk_device, "vkBindImageMemory")
	}
	if vma_vulkan_functions.allocate_memory == nil {
		vma_vulkan_functions.allocate_memory = auto_cast vk.GetDeviceProcAddr(self.vk_device, "vkAllocateMemory")
	}
	if vma_vulkan_functions.get_buffer_memory_requirements2_khr == nil {
		vma_vulkan_functions.get_buffer_memory_requirements2_khr = auto_cast vk.GetDeviceProcAddr(self.vk_device, "vkGetBufferMemoryRequirements2KHR")
	}
	if vma_vulkan_functions.get_buffer_memory_requirements2_khr == nil {
		vma_vulkan_functions.get_buffer_memory_requirements2_khr = auto_cast vk.GetDeviceProcAddr(self.vk_device, "vkGetBufferMemoryRequirements2")
	}
	if vma_vulkan_functions.get_image_memory_requirements2_khr == nil {
		vma_vulkan_functions.get_image_memory_requirements2_khr = auto_cast vk.GetDeviceProcAddr(self.vk_device, "vkGetImageMemoryRequirements2KHR")
	}
	if vma_vulkan_functions.get_image_memory_requirements2_khr == nil {
		vma_vulkan_functions.get_image_memory_requirements2_khr = auto_cast vk.GetDeviceProcAddr(self.vk_device, "vkGetImageMemoryRequirements2")
	}
	if vma_vulkan_functions.bind_buffer_memory2_khr == nil {
		vma_vulkan_functions.bind_buffer_memory2_khr = auto_cast vk.GetDeviceProcAddr(self.vk_device, "vkBindBufferMemory2KHR")
	}
	if vma_vulkan_functions.bind_buffer_memory2_khr == nil {
		vma_vulkan_functions.bind_buffer_memory2_khr = auto_cast vk.GetDeviceProcAddr(self.vk_device, "vkBindBufferMemory2")
	}
	if vma_vulkan_functions.bind_image_memory2_khr == nil {
		vma_vulkan_functions.bind_image_memory2_khr = auto_cast vk.GetDeviceProcAddr(self.vk_device, "vkBindImageMemory2KHR")
	}
	if vma_vulkan_functions.bind_image_memory2_khr == nil {
		vma_vulkan_functions.bind_image_memory2_khr = auto_cast vk.GetDeviceProcAddr(self.vk_device, "vkBindImageMemory2")
	}

	if vma_vulkan_functions.get_physical_device_properties == nil {
		log.error("VMA setup error: vkGetPhysicalDeviceProperties is nil")
		return false
	}
	if vma_vulkan_functions.get_physical_device_memory_properties == nil {
		log.error("VMA setup error: vkGetPhysicalDeviceMemoryProperties is nil")
		return false
	}
	if vma_vulkan_functions.get_buffer_memory_requirements2_khr == nil {
		log.error("VMA setup error: vkGetBufferMemoryRequirements2KHR is nil")
		return false
	}
	if vma_vulkan_functions.get_image_memory_requirements2_khr == nil {
		log.error("VMA setup error: vkGetImageMemoryRequirements2KHR is nil")
		return false
	}
	if vma_vulkan_functions.bind_buffer_memory2_khr == nil {
		log.error("VMA setup error: vkBindBufferMemory2KHR is nil")
		return false
	}
	if vma_vulkan_functions.bind_image_memory2_khr == nil {
		log.error("VMA setup error: vkBindImageMemory2KHR is nil")
		return false
	}
...
engine_init_swapchain :: proc(self: ^Engine) -> (ok: bool) {
	...
	draw_width := self.swapchain_extent.width
	draw_height := self.swapchain_extent.height
...
engine_init_background_pipeline :: proc(self: ^Engine) -> (ok: bool) {
	...
	if vk.CreateComputePipelines == nil {
		log.error("engine_init_background_pipeline: vk.CreateComputePipelines proc is nil")
		return false
	}

	create_result := vk.CreateComputePipelines(
			self.vk_device,
			0,
			1,
	...
	vk_check(create_result) or_return
...
engine_init_mesh_pipeline :: proc(self: ^Engine) -> (ok: bool) {
	...
	triangle_vertex_shader := create_shader_module(
		self.vk_device,
		#load("/shaders/compiled/tex_image_fallback.vert.spv"),
	) or_return
	...
	if self.mesh_pipeline_layout == 0 {
		log.error("mesh pipeline layout is null after CreatePipelineLayout")
	}
	...
	pipeline_builder_set_vertex_input_for_vertex_struct(&builder)
	...
	if self.mesh_pipeline == 0 {
		log.error("mesh pipeline is null after pipeline_builder_build")
	}
...
engine_init_default_data :: proc(self: ^Engine) -> (ok: bool) {
	...
	white := core.pack_unorm_4x8({1, 1, 1, 1})
	...
	grey := core.pack_unorm_4x8({0.66, 0.66, 0.66, 1})
	...
	black := core.pack_unorm_4x8({0, 0, 0, 0})
	...
	// Checkerboard image
	magenta := core.pack_unorm_4x8({1, 0, 1, 1})
	pixels: [16 * 16]u32
	for x in 0 ..< 16 {
		for y in 0 ..< 16 {
